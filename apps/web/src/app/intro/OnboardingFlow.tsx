...
const OnboardingFlow = () => {
  ...
  if (isSkipped) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-(--color-secondary) via-(--color-background) to-(--color-primary)/20 px-6">
  ...
  <div className="animate-slide-up flex flex-1 flex-col items-center justify-center px-6 text-center">
    ...
    <Card className="animate-fade-in-scale w-full max-w-sm border-0 bg-white/80 p-4 shadow-lg backdrop-blur-sm">
      ...
      <div className="space-y-3">
        <div className="h-3 w-3/4 rounded bg-(--color-(--color-light-gray))/50"></div>
        ...
        <div className="h-2 w-1/2 rounded bg-(--color-(--color-light-gray))/30"></div>
      </div>
    </Card>
  </div>
);

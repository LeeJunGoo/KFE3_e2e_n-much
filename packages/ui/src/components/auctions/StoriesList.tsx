...
const StoriesList = ({ mockStories }: { mockStories: StoriesProps[] }) => {
  const [currentPage, setCurrentPage] = useState(1);
  const totalPages = Math.ceil(mockStories.length / STORIES_PER_PAGE);
  ...
  return (
    <>
      ...
      <ul className="divide-y border-t">
        {currentStories.map((story: StoriesProps) => (
